...
function Sumar ()
{
    ...
    let precio3;
//van de este lado porque yo introduzco eL dato
    ...
    precio3 = parseInt(document.getElementById("txtIdPrecioTres").value); //si van al final es para ver el dato
...
function PrecioFinal () 
{
    ...
    impuesto = (precio1 + precio2 + precio3) * iva;
